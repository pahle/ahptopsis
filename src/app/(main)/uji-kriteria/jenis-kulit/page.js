...
const data = {
  tabel: [
    [1, 2, 1, 2, 1, 1, 1, 1, 1, 3], // Skintific
    [0.5, 1, 0.5, 1, 0.5, 1, 0.5, 1, 1, 2], // Somethinc Hooman
    [1, 2, 1, 2, 1, 1, 1, 1, 1, 3], // Instaperfect
    [0.5, 1, 0.5, 1, 0.5, 0.5, 0.5, 1, 1, 2], // Salsa
    [1, 2, 1, 2, 1, 1, 1, 1, 1, 3], // Wardah
    [1, 2, 1, 2, 1, 1, 1, 1, 1, 3], // Barenbliss
    [1, 2, 1, 2, 1, 1, 1, 1, 2, 3], // The Originote
    [1, 2, 1, 2, 1, 1, 1, 1, 1, 3], // True to Skin
    [1, 2, 1, 2, 1, 1, 1, 1, 1, 3], // Goute
    [
      0.333333333, 0.5, 0.333333333, 0.5, 0.333333333, 0.333333333, 0.333333333,
