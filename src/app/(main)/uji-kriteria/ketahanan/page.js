...
const data = {
  tabel: [
    [1, 2, 2, 3, 2, 2, 2, 3, 1, 4], // Skintific
    [0.5, 1, 1, 2, 1, 1, 1, 2, 0.5, 3], // Somethinc Hooman
    [0.5, 1, 1, 2, 1, 1, 1, 2, 0.5, 3], // Instaperfect
    [0.333333333, 0.5, 0.5, 1, 0.5, 0.5, 0.5, 1, 0.333333333, 1], // Salsa
    [0.5, 1, 1, 2, 1, 1, 1, 2, 0.5, 2], // Wardah
    [0.5, 1, 1, 2, 1, 1, 1, 2, 0.5, 3], // Barenbliss
    [0.5, 1, 1, 2, 1, 1, 1, 2, 0.5, 2], // The Originote
    [0.333333333, 0.5, 0.5, 1, 0.5, 0.5, 0.5, 1, 0.333333333, 1], // True to Skin
    [1, 2, 2, 3, 2, 2, 2, 3, 1, 4], // Goute
    [0.25, 0.333333333, 0.333333333, 1, 0.5, 0.333333333, 0.5, 1, 0.25, 1],
  ],
